...
@Component({
  ...
  templateUrl: './nhl-player-card.component.html',
  styleUrl: './nhl-player-card.component.scss',
})
export class NhlPlayerCardComponent {
  ...
  constructor(private nhlService: NhlService, public commonS: CommonService) {}
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
      ...
      this.getStatsList(statsId || 'TOI', 10, line);
    }, 100);
