...
@Component({
  ...
  templateUrl: './mlb-player-card.component.html',
  styleUrl: './mlb-player-card.component.scss',
})
export class MlbPlayerCardComponent {
  ...
  ngOnInit() {
    setTimeout(() => {
      ...
      this.getStatsList(statsId || 'HITS', 10, line);
    }, 100);
